 ...
 */
 ...
 /**
 * @module Puppeteer
 * @description The Web Puppeteer framework for the Soda Test Engine
 */
...
module.exports = function (soda) {
    /**
     * The Puppeteer framework driver for Soda
     * @constructor
     */
    var Puppeteer = function (soda) {
        var self   = this,

        /**
         * @composes PuppeteerDriver
         * @type Puppeteer
         */
        ...
        /**
         * Puppeteer doesn't support this method, and it will just call the completion callback with an error
         * @param  {Function} done A callback for completion
         * @return {Puppeteer} The current Puppeteer framework instance
         */
        this.build = function (done) {
            if(done instanceof Function) done(new Error("The puppeteer Soda driver does not implement `Framework.build`"), null);
            return self;
        };
        ...
        /**
         * Starts the Puppeteer framework driver
        ...
        this.start = function (browser, initialURL, options, done) {
            ...
            driver.start(
                ...
                function (err, started, d) {
                    ...
                    if(!started) {
                        if(done instanceof Function) done(new Error("Unable to start the Puppeteer framework"), false, null);
                        return;
                    }
        ...
        /**
         * Restarts the Puppeteer framework using the initial starting arguments
         * @param {function=} done A callback for completion
         * @return {Puppeteer} The current Puppeteer framework instance
         */
        ...
        /**
         * Gets the DOM tree from Puppeteer. First it sends a request to build the tree to Puppeteer, then when Puppeteer
         * responds, it calls the completion callback with the results.
         * @param {{}|function} options Options to pass to Puppeteer
         * @param {function=} done A callback for completion
         * @return {Puppeteer} The current Puppeteer framework instance
         */
    ...
    return Object.freeze(new Puppeteer (soda));
};
