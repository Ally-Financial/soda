 ...
 * @description The web v1.0 Soda stynax
 */
...
module.exports = function (action, $) {
    ...
    var path  = require("path"),
        webV1 = require(path.join(__dirname, "function"));
    ...
    action.on("screen/components/*/:assert:hasCountGreaterThan:using", $.core.assertHasCountGreaterThanUsing  , "screen", "assert", "Assert that the given selector, name, id, or value returns more than the provided number of elements"                                                       );
    action.on("screen/components/*/:assert:hasCountGreaterThan"      , $.core.assertHasCountGreaterThan       , "screen", "assert", "Assert that the given selector returns more than the provided number of elements"                                                                           );

    action.on("screen/components/*/:assert:hasCountLessThan:using", $.core.assertHasCountLessThanUsing  , "screen", "assert", "Assert that the given selector, name, id, or value returns less than the provided number of elements"                                                             );
    action.on("screen/components/*/:assert:hasCountLessThan"      , $.core.assertHasCountLessThan       , "screen", "assert", "Assert that the given selector returns less than the provided number of elements"                                                                                 );
    ...
    action.on("menu/components/*/:assert:hasCountGreaterThan:using", $.core.assertHasCountGreaterThanUsing  , "screen", "assert", "Assert that the given selector, name, id, or value returns more than the provided number of elements"                                                       );
    action.on("menu/components/*/:assert:hasCountGreaterThan"      , $.core.assertHasCountGreaterThan       , "screen", "assert", "Assert that the given selector returns more than the provided number of elements"                                                                           );

    action.on("menu/components/*/:assert:hasCountLessThan:using", $.core.assertHasCountLessThanUsing  , "screen", "assert", "Assert that the given selector, name, id, or value returns less than the provided number of elements"                                                             );
    action.on("menu/components/*/:assert:hasCountLessThan"      , $.core.assertHasCountLessThan       , "screen", "assert", "Assert that the given selector returns less than the provided number of elements"                                                                                 );
    ...
    action.on("popup/components/*/:assert:hasCountGreaterThan:using", $.core.assertHasCountGreaterThanUsing  , "screen", "assert", "Assert that the given selector, name, id, or value returns more than the provided number of elements"                                                       );
    action.on("popup/components/*/:assert:hasCountGreaterThan"      , $.core.assertHasCountGreaterThan       , "screen", "assert", "Assert that the given selector returns more than the provided number of elements"                                                                           );

    action.on("popup/components/*/:assert:hasCountLessThan:using", $.core.assertHasCountLessThanUsing  , "screen", "assert", "Assert that the given selector, name, id, or value returns less than the provided number of elements"                                                             );
    action.on("popup/components/*/:assert:hasCountLessThan"      , $.core.assertHasCountLessThan       , "screen", "assert", "Assert that the given selector returns less than the provided number of elements"                                                                                 );

    ///////////////////////////////////////////////////// ACTIONS //////////////////////////////////////////////////////

    action.on("actions/*/:deleteAllCookies"                         , webV1.deleteAllCookies      , "action", "deleteAllCookies"   , "Delete all the cookies stored in the browser", true);
    action.on("actions/*/:goto"                                     , webV1.goto                  , "action", "goto"   , "Go to a URL, you must include the protocol (e.g. 'http' or 'https')", true);
    action.on("actions/*/:back"                                     , webV1.back                  , "action", "back"   , "Navigate the browser history back one page"                         , true);
    action.on("actions/*/:forward"                                  , webV1.forward               , "action", "forward", "Navigate the browser history forward one page"                      , true);
    action.on("actions/*/:reload"                                   , webV1.reload                , "action", "reload" , "Reload the current page"                                            , true);

    action.on("actions/*/:close"                                    , webV1.close                 , "action", "close"  , "Closes the browser window", true);
    action.on("actions/*/:reset"                                    , webV1.reset                 , "action", "reset"  , "Closes and reopens the browser window", true);

    action.on("actions/*/:clickAll:options:refresh:using"           , webV1.clickAllUsingOptions  , "action", "clickAll", "Click all elements in the returned set, one after another, using the provided options object and using a name, id, label, value, or selector. If the value of refresh evaluates to false, the DOM will not be refreshed");
    action.on("actions/*/:clickAll:options:using"                   , webV1.clickAllUsingOptions  , "action", "clickAll", "Click all elements in the returned set, one after another, using the provided options object and using a name, id, label, value, or selector"                                                                           );
    action.on("actions/*/:clickAll:using"                           , webV1.clickAllUsing         , "action", "clickAll", "Click all elements in the returned set, one after another, using a name, id, label, value, or selector"                                                                                                                 );
    action.on("actions/*/:clickAll:options"                         , webV1.clickAllOptions       , "action", "clickAll", "Click all elements in the returned set, one after another, using the provided options object"                                                                                                                           );
    action.on("actions/*/:clickAll"                                 , webV1.clickAll              , "action", "clickAll", "Click all elements in the returned set, one after another"                                                                                                                                                              );

    action.on("actions/*/:click:options:refresh:using"              , webV1.clickUsingOptions     , "action", "click", "Click an element, using the provided options object and using a name, id, label, value, or selector. If the value of refresh evaluates to false, the DOM will not be refreshed");
    action.on("actions/*/:click:options:using"                      , webV1.clickUsingOptions     , "action", "click", "Click an element, using the provided options object and using a name, id, label, value, or selector");
    action.on("actions/*/:click:using"                              , webV1.clickUsing            , "action", "click", "Click an element, using a name, id, label, value, or selector");
    action.on("actions/*/:click:options:refresh"                    , webV1.clickOptions          , "action", "click", "Click an element, using the provided options. If the value of refresh evaluates to false, the DOM will not be refreshed");
    action.on("actions/*/:click:options"                            , webV1.clickOptions          , "action", "click", "Click an element, using the provided options");
    action.on("actions/*/:click:refresh"                            , webV1.click                 , "action", "click", "Click an element. If the value of refresh evaluates to false, the DOM will not be refreshed");
    action.on("actions/*/:click"                                    , webV1.click                 , "action", "click", "Click an element, using the default options");

    action.on("actions/*/:clickIfExists"                            , webV1.clickIfExists         , "action", "click", "Click an element using the default options, if it exists.");
    action.on("actions/*/:clickIfExists:options"                    , webV1.clickIfExists         , "action", "click", "Click an element using the options provided, if it exists.");
    ...
    action.on("actions/*/:as:lazy:store"                            , $.core.storeLazyAs          , "action", "store", "Store a variable that will not do replacements"                                                                                );
    ...
    action.on("actions/*/:as:default:saveIfExists"                  , $.core.saveAsIfExists       , "action", "save", "Save an element as a variable if it exists, others save default"                                                                                                                                         );
    action.on("actions/*/:as:asDecimal:default:property:saveIfExists"         , $.core.saveAsIfExists       , "action", "save", "Save an element as a variable if it exists, others save default"                                                                                                                                         );
    action.on("actions/*/:as:default:property:saveIfExists"         , $.core.saveAsIfExists       , "action", "save", "Save an element as a variable if it exists, others save default"                                                                                                                                         );
    ...
    action.on("actions/*/:switchToFrame:using"                      , webV1.switchToFrameUsing    , "action", "switchToFrame", "Swich to an iFrame, using a name, value, id, label, or selector" );
    action.on("actions/*/:switchToFrame"                            , webV1.switchToFrame         , "action", "switchToFrame", "Swich to an iFrame"                                              );
    ...
    action.on("actions/*/:resizeWindow"                             , webV1.resizeWindow          , "action", "resizeWindow", "Resize a window.<br><br><span class=\"bold\">Format: width,height. e.g. 500,500</span>"                                              , true);
    action.on("actions/*/:maximizeWindow"                           , webV1.maximizeWindow        , "action", "maximizeWindow", "Maximize a window."                                              , true);
    action.on("actions/*/:getVariable:storeIn"                      , webV1.getVariable           , "action", "getVariable", "Gets a variable."                                              , true);
    ...
    action.on("actions/*/:executeScript"                             , webV1.executeScript          , "action", "executeScript",    "Executes a JavaScript file"                                             , true);
    action.on("actions/*/:executeScript:storeIn:withString"                  , webV1.executeScriptWithString , "action", "executeScriptWithString",    "Executes a JavaScript string"                                             , true);
};
